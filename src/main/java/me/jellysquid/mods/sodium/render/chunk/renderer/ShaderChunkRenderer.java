...
public abstract class ShaderChunkRenderer implements ChunkRenderer {
    ...
    private GlProgram<ChunkShaderInterface> createShader(String path, boolean isShadowPass, SodiumTerrainPipeline pipeline, ChunkShaderOptions options) {        ShaderConstants constants = options.constants();
    ...
    private GlShader createFragmentShader(RenderDevice device, boolean isShadowPass, BlockRenderPass pass,
        ...
        if (pipeline != null) {
            ...
            if (isShadowPass) {
                if (pass == BlockRenderPass.OPAQUE || pass == BlockRenderPass.OPAQUE_DETAIL) {
            ...
            } else if (pass == BlockRenderPass.OPAQUE || pass == BlockRenderPass.OPAQUE_DETAIL) {
